...
/*Wifi任务*/
/*-摘要-*/	#define WIFI
/*-优先-*/	#define WIFI_TASK_PRIO		1
/*-堆栈-*/	#define WIFI_STK_SIZE 		300
/*-句柄-*/	TaskHandle_t WifiTask_Handler;
/*-声明-*/	extern void Wifi_Task(void *pvParameters);
...
/*矿石状态任务*/
/*-摘要-*/	#define ORE
/*-优先-*/	#define ORE_TASK_PRIO		1
/*-堆栈-*/	#define ORE_STK_SIZE 		1000
/*-句柄-*/	TaskHandle_t OreTask_Handler;
/*-声明-*/	extern void Ore_Task(void *pvParameters);

/*赚钱任务*/
/*-摘要-*/	#define MONEYTAKING
/*-优先-*/	#define MONEYTAKING_TASK_PRIO		1
/*-堆栈-*/	#define MONEYTAKING_STK_SIZE 		1000
/*-句柄-*/	TaskHandle_t MoneyTakingTask_Handler;
/*-声明-*/	extern void MoneyTaking_Task(void *pvParameters);
...
//	creatResult[taskNum++]= 	mTaskCreate(WIFI,Wifi);//wifi任务
	creatResult[taskNum++]= 	mTaskCreate(ORE,Ore);//矿石状态任务
	creatResult[taskNum++]= 	mTaskCreate(MONEYTAKING,MoneyTaking);//赚钱任务
